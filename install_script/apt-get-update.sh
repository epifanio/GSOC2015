...
apt-get install -y ruby ruby-dev julia octave postgresql-9.4-postgis-2.1 rubygems libgemplugin-ruby rubygems-integration \
	postgresql-server-dev-9.4 libreadline6-dev mlocate pkg-config \
